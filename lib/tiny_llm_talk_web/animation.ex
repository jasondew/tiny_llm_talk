defmodule TinyLlmTalkWeb.Animation do
  ...
  holds the last frame; `restart/1` starts it over. With the pace paused
  ...
  @doc "Starts the clock if the slide wants one, it is not already running, and it is not paused."
  ...
  @doc "Back to the first frame, with the clock running unless paused."
